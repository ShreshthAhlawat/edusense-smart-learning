...
function makeSettings(role: "teacher" | "student") {
    ...
    return (
      <DashboardShell role={role} greeting="Settings">
        ...
        <div className="glass rounded-2xl p-6 max-w-lg space-y-4">
          ...
          <div>
            <Label>Role</Label>
            <Input value={profile?.role ?? ""} disabled className="mt-1 capitalize" />
          </div>
